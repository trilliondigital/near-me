...
/**
 * GET /poi/categories - Get all supported POI categories
 */
...
/**
 * GET /poi/search - Search for POIs near a location
 */
...
/**
 * GET /poi/category/:category - Get POIs by category near a location
 */
...
/**
 * GET /poi/closest/:category - Find the closest POI of a specific category
 */
...
/**
 * GET /poi/nearby-all - Get all POI categories near a location
 */
...
/**
 * POST /poi/validate-category - Validate if a category is supported
 */
